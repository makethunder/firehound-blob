...
class FacebookBlob implements BlobInterface
{
    ...
    public function fromArray($array)
    {
        ...
        $this->geographicTargeting  = $this->safeGet($array, self::GEOGRAPHIC_TARGETING); // versioned
        $this->demographicTargeting = $this->safeGet($array, self::DEMOGRAPHIC_TARGETING); // versioned
        $this->audienceTargeting    = $this->safeGet($array, self::AUDIENCE_TARGETING); // versioned
        ...
        $this->adSets               = $this->safeGet($array, self::AD_SETS); // versioned, might need builder
        $this->creative             = $this->safeGet($array, self::CREATIVE); // versioned, might need builder
    }
}
